...
class __$$_LoadingCopyWithImpl<$Res>
    extends _$TodosStateCopyWithImpl<$Res, _$_Loading>
...
class _$_Loaded implements _Loaded {
  const _$_Loaded(this.todos, {final String? $type}) : $type = $type ?? 'ready';
  ...
  @override
  String toString() {
    return 'TodosState.ready(todos: $todos)';
  }
...
abstract class _Loaded implements TodosState {
  const factory _Loaded(final Todos todos) = _$_Loaded;
...
class _$_Error implements _Error {
  ...
  @override
  String toString() {
    return 'TodosState.error(message: $message)';
  }
